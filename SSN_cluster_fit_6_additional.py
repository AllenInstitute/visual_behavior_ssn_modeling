...
types = ["G"]  # G + image, H + non-image, Full G-H interpolation
...
for type in types:
    data, stim = cnd.prepare_interp_data_for_fit(fracs, type, alternate=True)
...
store_file_name = homedir + f"ssn_model/fit_result6/result_{seed:04d}.pkl"
